...
using VisualCoddingLAB7.Models;
using Avalonia.Media;
namespace VisualCoddingLAB7.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<Note> BuildAllNotes()
        {
            ...
            {
                new Note("Яков Пивчик Генадьевич","2","1","2","0","1","1","2",false),
                new Note("Артемьев Григорий Николаевич","1","1","1","1","1","1","1",false),
                new Note("Гармаш Валерия Костылева","2","0","0","0","2","0","0",false),
            };
        }
